...
The goal is to demonstrate practical problem-solving skills in a lab environment.

---

## 📂 Incident Reports

- [DHCP-DNS-Issue](D:\ProgramFiles\it-support-labs\DHCP-DNS-Issue)  
...
- [Printer-Issue](D:\ProgramFiles\it-support-labs\Printer-Issue)  
...
- [AD-Login-Issue](D:\ProgramFiles\it-support-labs\AD-Login-Issue)  
...
- **Server**: Windows Server 2019 (AD DS, DHCP, DNS roles)  
- **Clients**: Windows 10 / 11, Ubuntu 24.04.3 LTS  
- **Virtualization**: Hyper-V / VirtualBox  
- **Tools**: PowerShell, Event Viewer, RDP, TeamViewer, Git
